// Script to fix links in both category and quiz page footers with correct paths
const fs = require('fs');
...
// From category pages, we need to go up two levels to reach the root directory
...
// From quiz pages, we need to go up two levels to reach the root directory
const quizFooter = `
    <footer class="simple-footer">
        <div class="container">
            <div class="simple-footer-content">
